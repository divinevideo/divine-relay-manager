...
import { UNDERAGE_CATEGORIES } from '../../shared/categories';
...
export class ReportWatcher implements DurableObject {
  ...
  private handleReportEvent(event: ReportEvent): void {
    ...
    if (UNDERAGE_CATEGORIES.includes(category) && reportedPubkey && !this.pendingAgeReviewPubkeys.has(reportedPubkey)) {
