...
describe('HIGH_PRIORITY_CATEGORIES', () => {
  it('includes child-safety and underage aliases', () => {
    expect(HIGH_PRIORITY_CATEGORIES).toContain('NS-childSafety');
    expect(HIGH_PRIORITY_CATEGORIES).toContain('NS-child-safety');
    expect(HIGH_PRIORITY_CATEGORIES).toContain('childSafety');
    expect(HIGH_PRIORITY_CATEGORIES).toContain('child-safety');
    expect(HIGH_PRIORITY_CATEGORIES).toContain('NS-underageUser');
    expect(HIGH_PRIORITY_CATEGORIES).toContain('NS-underage-user');
    expect(HIGH_PRIORITY_CATEGORIES).toContain('underageUser');
    expect(HIGH_PRIORITY_CATEGORIES).toContain('underage-user');
  });
});
